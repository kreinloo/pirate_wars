...
GameServer = (function (server) {
	...
	this.endGame = function (gid) {
		...
		this.server.getClientById(p1Id).setGameStatus(GAME.STATUS.IDLE)
		this.server.getClientById(p2Id).setGameStatus(GAME.STATUS.IDLE);
	...
	this.getActiveGames = function () {
		...
		for (var i in this.activeGames) {
			...
			gameRecord = {
				...
				player2 : game.players[game.pids[0]].getName()
			}
...
var Game = (function (gid, gameServer, player1, player2) {
	...
	this.players[player2.getID()] = new Player(player2.getID(),
		player2.getName());
	this.name = "PID: " + this.gid + " " + player1.getName() + " vs " +
		player2.getName();
	...
	this.endGame = function (winner_id) {
		this.sendEventResult({
			pid : this.pids[0],
